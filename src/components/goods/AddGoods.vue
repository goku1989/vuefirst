  ...
  <div>
    <el-form class="login-container" ref="ruleForm" :model="ruleForm" :rules="rules">
      ...
      <el-form-item prop="goodsCode">
        <el-input v-model="ruleForm.goodsCode" placeholder="商品编码"></el-input>
      </el-form-item>
      <el-form-item prop="goodsName">
        <el-input v-model="ruleForm.goodsName" placeholder="商品名称"></el-input>
      </el-form-item>
      <el-form-item>
    ...
    methods: {
      ...
      onSubmit(formName) {
        this.$refs[formName].validate((valid) => {
            ...
            if (valid) {
                var url = "http://101.200.171.172:20000/dbmall-goods/goodsInfo/insertGoods"
